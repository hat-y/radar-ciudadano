...
<div style="text-align: center; font-family:sans-serif; margin:0;padding:0; background-color: #FFFFFF;">
  ...
  <div style="padding:20px; border-radius:20px;">
    ...
    <p style="color: #333333; margin-bottom: 15px;">Estimado/a futuro/a colaborador/a,</p>
    <p style="color: #333333; margin-bottom: 15px;">El equipo editorial de Conciencia se complace en invitarte a unirte a nuestra plataforma como: <strong>ROLE_PLACEHOLDER</strong>.</p>
    <p style="margin-bottom:30px; color: #333333;">Para aceptar esta invitación y comenzar tu colaboración, por favor haz clic en el siguiente botón:</p>
