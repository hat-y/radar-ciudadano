...
<div style="text-align: center; font-family:sans-serif; margin:0;padding:0; background-color: #FFFFFF;">
  ...
  <div style="padding:20px; border-radius:20px;">
    ...
    <p style="color: #333333; margin-bottom: 15px;">Hemos recibido una solicitud para restablecer la contraseña de tu cuenta. Si no solicitaste esto, puedes ignorar este correo.</p>
    <p style="margin-bottom:30px; color: #333333;">Para restablecer tu contraseña, haz clic en el botón de abajo:</p>
    ...
    <p style="color: #333333;">Si tienes problemas, contacta con nuestro soporte.</p>
